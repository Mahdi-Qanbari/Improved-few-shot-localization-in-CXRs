...
model = dict(
    backbone=dict(
        ...
        frozen_stages=1,
        init_cfg=dict(
            checkpoint='checkpoints/resnet50.pth', type='Pretrained'),
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/home/woody/iwi5/iwi5237h/VinDr-CXR/vindrcxr_test.json',
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='/home/woody/iwi5/iwi5237h/VinDr-CXR/data1/val1.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
vis_backends = [
    ...
    dict(save_dir='runs', type='TensorboardVisBackend'),
]
visualizer = dict(
    name='visualizer',
